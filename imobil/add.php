...
class PropertyWebPage extends MainWebPage {
	...
	function __construct(){
		...
		if ((isset($this->id))){
			...
			$i=new Image();
			$is=$i->getAll("reftype='i' and reftypeid=".$p->id);
...
//		}
	...
	function setDetails(){
		...
		if ($this->currentproperty->tipimobil_id==11){					
			$out.=$this->setOfertaImobilApartament();	
		}
		if ($this->currentproperty->tipimobil_id==12){					
			$out.=$this->setOfertaImobilCasaVila();	
		}
		if ($this->currentproperty->tipimobil_id==13){	
			$out.=$this->setOfertaImobilTeren();	
		}
		if ($this->currentproperty->tipimobil_id==14){	
			$out.=$this->setOfertaImobilComercial();	
		}
		/*
		...
		*/
		if ($this->currentproperty->tipimobil_id==31){
			$out.=$this->setCerereImobilApartament();	
		}
		if ($this->currentproperty->tipimobil_id==32){
			$out.=$this->setCerereImobilCasaVila();	
		}
		if ($this->currentproperty->tipimobil_id==33){
			$out.=$this->setCerereImobilTeren();	
		}
		if ($this->currentproperty->tipimobil_id==34){
			$out.=$this->setCerereImobilComercial();	
		}
		/*
	...
	function setCerereImobilApartament(){
		...
		$out.='<table class="property-table" align="center" style="width: 100%;">';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 40%;">Apartament preferat:</td>';
		$out.='<td style="width: 60%;">'.$this->getSubTipImobilDropDown($this->currentproperty->tipimobil_id,$this->currentproperty->subtipimobil_id).'</td>';		$out.='</tr>';
		$out.='<tr>';		
		$out.='<td class="property-name" style="width: 40%;">Suprafata preferata(m2):</td>';
		$out.='<td style="width: 60%;"><input type="text" id="aria_totala" name="aria_totala" value="'.$this->currentproperty->aria_totala.'"></td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 40%;">Etajul preferat:</td>';
		$out.='<td style="width: 60%;"><input id="etaj" type="text" name="etaj" class="input" value="'.$this->currentproperty->etaj.'"></td>';
		$out.='</tr>';		
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 40%;">Pret preferat:</td>';
		$out.='<td style="width: 60%;"><div>';
		$out.='<input id="pret" type="text" name="pret" value="'.$this->currentproperty->pret.'">';		
		$out.=$this->getValuta($this->currentproperty->valuta_id);
		$out.='/';
		$out.=$this->getMasura($this->currentproperty->tipimobil_id,$this->currentproperty->masura_id);
		...
		//$out.='<table class="property-table" align="center" style="width: 100%;">';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 40%;">Municipiul/Raionul preferat:</td>';
		$out.='<td style="width: 60%;">'.$this->getRaionDropDown($this->currentproperty->raion_id).'</td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 40%;">Oras/Sat preferat:</td>';
		$out.='<td style="width: 60%;">'.$this->getLocationDropDown($this->currentproperty->raion_id,$this->currentproperty->localitate_id).'</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 40%;">Sector preferat:</td>';
		$out.='<td style="width: 60%;">'.$this->getSectorDropDown($this->currentproperty->localitate_id,$this->currentproperty->sector_id).'</td>';
		$out.='</tr>';
		//$out.='</table>'; 
		//$out.='</fieldset>';
		...
		//$out.='<table class="property-table">';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 40%;">Note:</td>';
		$out.='<td style="width: 60%;"><textarea id="note" name="note">'.$this->currentproperty->note.'</textarea></td>';
		$out.='</tr>'; 			
		$out.='</table>'; 			
		//$out.='</fieldset>'; 	
	...
	function setCerereImobilCasaVila(){
		...
		//$out.='<table class="property-table" align="center" style="width: 100%;">';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Municipiul/Raionul preferata:</td>';
		$out.='<td style="width: 70%;">'.$this->getRaionDropDown($this->currentproperty->raion_id).'</td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Oras/Sat preferata:</td>';
		$out.='<td style="width: 70%;">'.$this->getLocationDropDown($this->currentproperty->raion_id,$this->currentproperty->localitate_id).'</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 25%;">Sector preferata:</td>';
		...
		//$out.='<table class="property-table">';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Alte Note:</td>';
		$out.='<td style="width: 70%;"><textarea id="note" name="note">'.$this->currentproperty->note.'</textarea></td>';
		$out.='</tr>'; 			
		$out.='</table>'; 			
		//$out.='</fieldset>'; 	
	...
	function setCerereImobilTeren(){
		...
		$out.='<table class="property-table" align="center" style="width: 100%;">';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Tip Teren Preferat:</td>';
		$out.='<td style="width: 70%;">'.$this->getSubTipImobilDropDown($this->currentproperty->tipimobil_id,$this->currentproperty->subtipimobil_id).'</td>';
		$out.='</tr>';
		$out.='<tr>';		
	...
	function setCerereImobilComercial(){
		...
		//$out.='<table class="property-table">';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 25%;">Alte Note:</td>';
		$out.='<td style="width: 25%;"><textarea id="note" name="note">'.$this->currentproperty->note.'</textarea></td>';
		$out.='</tr>'; 			
		$out.='</table>'; 			
		//$out.='</fieldset>'; 
	...
	function setAdress1($a){
		$out='';
		$out.='<table class="property-table" align="center" style="width: 100%;">';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Municipiul/Raionul:</td>';
		$out.='<td style="width: 70%;">'.Raion::getRaionDropDown($a->raion_id).'</td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Oras/Sat:</td>';
		$out.='<td style="width: 70%;">'.Location::getLocationDropDown($a->raion_id,$a->localitate_id).'</td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Sector:</td>';
		$out.='<td style="width: 70%;">'.Sector::getSectorDropDown($a->localitate_id,$a->sector_id).'</td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Strada:</td>';
		$out.='<td style="width: 70%;"><input type="text" id="strada" name="strada" class="input" value="'.$a->strada.'"></td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Nr. Casa:</td>';
		$out.='<td style="width: 70%;"><input type="text" id="casa_nr" name="casa_nr" class="input" value="'.$a->casa_nr.'"></td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Nr. Scara:</td>';
		$out.='<td style="width: 70%;"><input type="text" id="scara_nr" name="scara_nr" class="input" value="'.$a->scara_nr.'"></td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Nr. Apartament:</td>';
		$out.='<td style="width: 70%;"><input type="text" id="apartament_nr" name="apartament_nr" class="input" value="'.$a->apartament_nr.'"></td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Note la Adresa:</td>';
		$out.='<td style="width: 70%;"><textarea id="noteadresa" name="noteadresa" class="text">'.$a->noteadresa.'</textarea></td>';
		$out.='</tr>'; 			
		$out.='</table>'; 
		return $out;	
	}
	...
	function setContacts1($c){
		...
		$out.='<td style="width: 70%;"><input type="text" id="name" name="name" value="'.$c->name.'"></td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Url:</td>';
		$out.='<td style="width: 70%;"><input type="text" id="url" name="url" value="'.$c->url.'"></td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Fix:</td>';
		$out.='<td style="width: 70%;"><input type="text" id="phone" name="phone" value="'.$c->phone.'"></td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Mobil:</td>';
		$out.='<td style="width: 70%;"><input type="text" id="mobile" name="mobile" value="'.$c->mobile.'"></td>';
		$out.='</tr>';
		$out.='<tr>';
		$out.='<td class="property-name" style="width: 30%;">Email:</td>';
		$out.='<td style="width: 70%;"><input type="text" id="email" name="email" value="'.$c->email.'"></td>';
		$out.='</tr>';
		//$out.='</table>';	
		//$out.='</fieldset>'; 
		...
		$out.='<td style="width: 70%;"><textarea id="notecontact" name="notecontact">'.$c->note.'</textarea></td>';
		$out.='</tr>'; 			
		$out.='</table>'; 			
		//$out.='</fieldset>'; 
