...
W.prototype.ci=function()
{
    ...
    if(v.type==2)
    {
        for(var b=a.firstChild;b.nextSibling;)
        {
            Ub(b.nextSibling);
            od(b.nextSibling)
        }
    ...
    {
        for(var b=a.firstChild.nextSibling;b;b=b.nextSibling)
        {
            I(b,"coords","0,0,0,0");
            Ub(b)
        }
...
function ig(a)
{
    ...
    {
        for(var c=0;c<k(a.childNodes);++c)
        {
